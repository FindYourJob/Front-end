GraphManager = (function (){
	...
	GraphManagerp.prototype = {
		...
		//TODO FIXME LOL Jean ne sait pas � quoi sert ceci alors qu'il l'a cod�.
		getNAID:function(){
			this.NAID++;
			return this.NAID;
		},
		//FIXME nodeByTitle peut renvoyer plusieurs noeuds => pas bien et pas pr�vu. En plus devrait p-� prendre le type en arg
